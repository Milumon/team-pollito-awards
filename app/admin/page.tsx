                    ...
                    <td className="py-3 px-2">
                      <div className="flex items-center gap-3">
                        <div className="w-9 h-9 rounded-2xl border border-neutral-700/60 bg-[#2b2d31] overflow-hidden shrink-0 flex items-center justify-center ">
                          {u.robloxAvatarUrl ? (
                            // eslint-disable-next-line @next/next/no-img-element
                            <img src={u.robloxAvatarUrl} alt={u.robloxUser || 'User'} className="w-full h-full object-cover object-top" />
                          ) : (
                            <span className="text-sm">🐣</span>
                          )}
                        </div>
                ...
                <div className="space-y-2">
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-8 rounded-full bg-[#1e1f22] overflow-hidden shrink-0">
                      {u.robloxAvatarUrl ? (
                        // eslint-disable-next-line @next/next/no-img-element
                        <img src={u.robloxAvatarUrl} alt={u.robloxUser || ''} className="w-full h-full object-cover object-top" />
                      ) : (
              ...
              <div className="flex items-center gap-3 mb-5 border-b-2 border-black pb-3 shrink-0">
                <div className="w-11 h-11 rounded-lg border border-neutral-700/60 bg-[#171A20] overflow-hidden flex items-center justify-center shrink-0 ">
                  {inspectingUser.robloxAvatarUrl ? (
                    // eslint-disable-next-line @next/next/no-img-element
                    <img src={inspectingUser.robloxAvatarUrl} alt={inspectingUser.robloxUser || 'User'} className="w-full h-full object-cover object-top" />
                  ) : (
                    <span className="text-xl">🐣</span>
                  )}
                </div>
                ...
                <div className="w-11 h-11 rounded-lg border border-neutral-700/60 bg-[#171A20] overflow-hidden flex items-center justify-center shrink-0 ">
                  {adminVerifiedProfile ? (
                    adminVerifiedProfile.avatarUrl ? (
                      <img src={adminVerifiedProfile.avatarUrl} alt={adminVerifiedProfile.displayName} className="w-full h-full object-cover object-top" />
                    ) : (
                      <span className="text-xl">🐣</span>
                    )
                  ) : editingUser.robloxAvatarUrl ? (
                    // eslint-disable-next-line @next/next/no-img-element
                    <img src={editingUser.robloxAvatarUrl} alt={editingUser.robloxUser || 'User'} className="w-full h-full object-cover object-top" />
                  ) : (
                    <span className="text-xl">🐣</span>
                  )}
                </div>
