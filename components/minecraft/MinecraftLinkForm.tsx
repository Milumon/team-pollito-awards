...
function StepThree({ edition, code, expiresAt, remainingSeconds, onNext, onBack, onCopy, copied }: Readonly<{ edition: 'java' | 'bedrock'; code: string; expiresAt: string | null; remainingSeconds: number | null; onNext: () => void; onBack: () => void; onCopy: () => void; copied: boolean }>) {
